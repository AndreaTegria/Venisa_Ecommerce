      ...
      <div className="mx-auto bg-gray-100 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow">
          <div className="p-6 sm:p-12">
            ...
            <div className="mt-6">
              <h1 className="font-bold text-lg">Tus Direcciones :</h1>
              {pageLevelLoader ? (
                <PulseLoader
                  color={"#000000"}
                ...
                <div className="mt-4 flex flex-col gap-4">
                  {addresses && addresses.length ? (
                    ...
                    <p>Direccion no encontrada ! Favor agrega nueva direccion</p>
                  )}
                </div>
              )}
            </div>
            <div className="mt-4">
              <button
                ...
                className="mt-5  inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
              >
                {showAddressForm ? "OCULTAR FORMULARIO " : "AGREGAR NUEVA DIRECCION"}
              </button>
            </div>
            {showAddressForm ? (
