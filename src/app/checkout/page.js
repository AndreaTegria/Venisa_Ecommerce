...
export default function Checkout() {
  ...
  const publishableKey =
    "pk_test_51OrAUgKfkZY5F3VJbYwQXxvYBb7TM1hM9CvSTVbtHXbvYGDw8DADqT24zbvyT7uFqpwjxtfvNTP6FPJyc1MBCGrO00oeJ2sD1m";
            ...
            <div className="bg-white shadow">
              <div className="px-4 py-6 sm:px-8 sm:py-10 flex flex-col gap-5">
                <h1 className="font-bold text-lg">
                  ¡Tu pago se ha realizado con éxito y serás redirigido a la
                  página de pedidos en 2 segundos!
                </h1>
              </div>
            </div>
          </div>
      ...
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          ...
          <p className="text-gray-400 font-bold">
            Completa tu pedido seleccionando una dirección
          </p>
          <div className="w-full mt-6 mr-0 mb-0 ml-0 space-y-6">
            {addresses && addresses.length ? (
              ...
              <p>No se han añadido direcciones</p>
            )}
          </div>
          <button
